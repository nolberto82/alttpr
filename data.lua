...
item_rooms_data_dw[2] = Item:new(
    ...
    { 0xde49 }, { 0, 0, 0, 0, 1, 0, 0, 1, 2, 0, 1, 0, 1, 7 }, { 0x0e })
...
item_rooms_data_dw[7] = Item:new({ 0x0184, 0x0186, 0x0186, 0x0166, 0x0144, 0x0182, 0x01a2, 0x0120 }, { 0x2391 },
...
item_rooms_data_dw[8] = Item:new(
    ...
    { 0xd919 }, { 0, 0, 1, 0, 0, 0, 0, 0, 1, 2, 3, 7 }, { 0x0c })
...
itemsxy =
{
    ...
    { --16 thieves' town
        ...
        { 0xb8, 0x3a, 0x002f, 0x60, 0x0158, 0 },
        --B2
    ...
    { --18 turtle rock
        ...
        --B3
        { 0xa0, 0x8a, 0x007f, 0x60, 0x01aa, 7 },
    },
    { --1a ganon's tower
        --B1
...
travelpos =
{
    ...
    [2] =
    {
        ...
        { "Lumberjacks",   { 0x0079, 0x04e2, 0x00db, 0x0558, 0x0005, 0x000e, 0x0042, 0x041e, 0x00ea, 0x055f } },
